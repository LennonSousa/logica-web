    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          title: "Imprimir orçamento",
          description:
            "Imprimir orçamento da plataforma de gerenciamento da Lógica Renováveis.",
          images: [
            {
                          ...
                          <Row className="mb-3 d-print-none">
                            <Col>
                              <PageBack
                                ...
                                subTitle="Voltar para os detalhes do orçamento"
                              />
                            </Col>
                          ...
                          <Row className="mb-5 text-center">
                            <Col>
                              <h4 className="text-dark text-wrap">
                                PROPOSTA TÉCNICA E COMERCIAL<br></br>
                          ...
                          <Row className="mb-5">
                            <Col>
                              <span className="text-secondary text-wrap">
                                <p>
                                  A Lógica está no mercado há mais de 12 anos,
                                  oferecendo serviços e atendimento de
                                  qualidade, nossos profissionais são
                                ...
                                <p>
                                  Nossa empresa está devidamente registrada nos
                                  órgãos competentes do setor, nosso corpo
                                  técnico consta com engenheiro eletricista,
                                  técnicos e instaladores registrados e
                                  certificados para dar mais segurança técnica,
                                  física e jurídica aos nossos clientes.
                                </p>

                                <p>
                                  Somos registrados no CREA-MA (CONSELHO
                                  REGIONAL DE ENEGENHARIA E AGRONOMIA), ABGD
                                  (ASSOCIAÇÃO BRASILEIRA DE GERAÇÃO DISTRIBUIDA)
                                  e PORTAL SOLAR. Consideramos ser de suma
                                  importância para nossos clientes estar
                                  devidamente credenciados no maior número de
                                  órgãos possíveis do setor, para que sempre,
                          ...
                          <Row className="mb-1">
                            ...
                            <Col sm={4}>
                              <Row>
                                <Col>
                                  <span className="text-success">
                                    Capacidade de geração do Sistema
                                  </span>
                                </Col>
                              </Row>
                          ...
                          <Row className="mb-3">
                            <Col>
                              <span className="text-secondary text-wrap">
                                ...
                                propostas neste orçamento, com validade de 10
                                (dez) dias:
                              </span>
                            </Col>
                          </Row>
